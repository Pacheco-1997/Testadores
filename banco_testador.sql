...
ATIVO BOOL NOT NULL DEFAULT TRUE,
ID_TESTADOR INT,
CONSTRAINT FK_TESTADOR_EVENTOS FOREIGN KEY (ID_TESTADOR) REFERENCES TESTADORES(ID_TESTADOR),
...
ATIVO BOOL NOT NULL DEFAULT TRUE,
ID_TESTADOR INT,
CONSTRAINT FK_TESTADOR_PRODUTOS FOREIGN KEY (ID_TESTADOR) REFERENCES TESTADORES(ID_TESTADOR),
